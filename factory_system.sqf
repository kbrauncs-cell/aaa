...
player addAction ["Open Crate Spawner", {
    ...
    _btnSpawnFactory ctrlAddEventHandler ["ButtonClick", {
        ...
        if (_factoryType == "Town") then {
            ...
            if (_townCount == 0) then {
                ...
                _nearFood = nearestObjects [CRATE_PENDING_LOCATION, ["Land_FoodSacks_01_large_brown_idap_F"], 100];
    ...
    _btnUpgrade ctrlAddEventHandler ["ButtonClick", {
        ...
        _nearFood = nearestObjects [_factoryPos, ["Land_FoodSacks_01_large_brown_idap_F"], 50];
    ...
    _btnResupply ctrlAddEventHandler ["ButtonClick", {
        ...
        if (_factoryType == "Mineral" || _factoryType == "Pier") then {
            ...
            _foodValue = 0;
            {
                _itemCount = _x getVariable ["crateItemCount", 50];
                _maxCapacity = _x getVariable ["crateMaxCapacity", 50];
        ...
        if (_factoryType == "Powerplant") then {
            ...
            {
                _itemCount = _x getVariable ["crateItemCount", 50];
                _waterValue = _waterValue + (_itemCount / 50);
            } forEach _nearWater;
                ...
                if (_factoryType == "Town") then {
                    ...
                    if (_taskPending) then {
                        ...
                        try {
                            ...
                            if (_crateType == "Land_FoodSacks_01_large_brown_idap_F") then {
                                ...
                                _inventoryBox addItemCargoGlobal ["ACE_MRE_ChickenTikkaMasala", 50];
                                _crate setVariable ["inventoryBox", _inventoryBox, true];
                                _crate setVariable ["crateItemCount", 50, true];
                                _crate setVariable ["crateMaxCapacity", 50, true];
                                _crate setVariable ["crateMaxDrops", 3, true];
                            ...
                            if (_crateType == "Land_PaperBox_01_open_water_F") then {
                                ...
                                clearWeaponCargoGlobal _inventoryBox; clearMagazineCargoGlobal _inventoryBox; clearItemCargoGlobal _inventoryBox; clearBackpackCargoGlobal _inventoryBox;
                                clearBackpackCargoGlobal _inventoryBox;
                                _inventoryBox addItemCargoGlobal ["ACE_WaterBottle", 50];
                                _crate setVariable ["inventoryBox", _inventoryBox, true];
                                _crate setVariable ["crateItemCount", 50, true];
                                _crate setVariable ["crateMaxCapacity", 50, true];
                                _crate setVariable ["crateMaxDrops", 3, true];
            ...
            if (_selectedIndex >= 0 && _selectedIndex < count CRATE_FACTORY_POSITIONS) then {
                ...
                if (_needsRebuild) then {
                    ...
                    if (_factoryType == "Town") then {
                        ...
                        _comboType lbSetData [0, "Land_FoodSacks_01_large_brown_idap_F"];
...
[] spawn {
    while {true} do {
        ...
        {
            _crate = _x;
            _itemCount = _crate getVariable ["crateItemCount", 50];
            ...
            _maxCapacity = _crate getVariable ["crateMaxCapacity", 50];
            _maxDrops = _crate getVariable ["crateMaxDrops", 3];
            ...
            if (_countdownStarted) then {
                ...
                if (_graceTime > 0) then {
                    ...
                    _initialCount = _crate getVariable ["initialDroppedCount", 3];
